...
// Returns the private 'App\Repository\ContainerModelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContainerModelRepository.php';

return $this->privates['App\Repository\ContainerModelRepository'] = new \App\Repository\ContainerModelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
