...
// Returns the private 'App\Repository\ContainerProductRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContainerProductRepository.php';

return $this->privates['App\Repository\ContainerProductRepository'] = new \App\Repository\ContainerProductRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
