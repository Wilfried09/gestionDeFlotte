...
// Returns the private 'App\Repository\ContainershipRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContainershipRepository.php';

return $this->privates['App\Repository\ContainershipRepository'] = new \App\Repository\ContainershipRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
