...
// Returns the private 'App\Repository\ContainerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContainerRepository.php';

return $this->privates['App\Repository\ContainerRepository'] = new \App\Repository\ContainerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
